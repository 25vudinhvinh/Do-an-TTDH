...
const Home = () => {
    ...
    return (
        <div className="fixed right-0 left-0 bottom-0 top-0 flex">
            ...
            <div tabIndex="-1" className="fixed left-[65px] top-0 w-[27%] z-2">
                <Popup />
            </div>
            {showButtonGroup && (
                <div
                    tabIndex="-1"
                    className="fixed left-[40%] w-[45%] px-3 top-6 z-20 overflow-x-hidden"
                >
                    <ButtonGroup />
                </div>
            )}
            <div tabIndex="-1" className="fixed right-[20px] top-3 z-99">
